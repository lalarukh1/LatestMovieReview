...
<div id="app">
    ...
    <div class="flex flex-row w-full">
            ...
            <div class="flex w-48 h-70 flex-no-wrap mt-2 border mr-8 shadow-sm bg-grey-darkest">
                ...
                <div class="flex flex-col p-2">
                    ...
                    <div class="flex text-sm font-sans text-white w-8 h-8 mb-8 mt-4">
                        <ais-input placeholder="Search" :class-names="{'ais-input': 'form-control'}"></ais-input>
                ...
                <div class="text-sm font-sans pt-2 pb-2 no-underline text-white">
                    <ais-refinement-list attribute-name="opening_date" :classNames="{'ais-refinement-list__count': 'badge','ais-refinement-list__item': 'checkbox'}">
                    ...
                    <ais-refinement-list attribute-name="byline" :classNames="{'ais-refinement-list__count': 'badge','ais-refinement-list__item': 'checkbox'}">
                        <template slot="header">
                                    ...
                                    <img class="flex" :src="result.src" style="height: 200px">
                                         <div class="p-2 pt-2 bg-grey-darker h-40">
                                             <div class="font-bold text-white text-xl mb-2">
                                                <ais-highlight :result="result" attribute-name="display_title"></ais-highlight>
                                            </div>
                                            <p class="text-grey-light text-sm">
                                                <ais-highlight :result="result" attribute-name="summary_short"></ais-highlight>
                                            </p>
                                        </div>
                                        <div class="bg-grey-darkest p-3 text-center">
                                            <span class="inline-block text-lg font-bold text-pink-custom mr-2 ">
                                                <a :href="result.url" class="no-underline text-pink-custom">Read Review</a>
                                            </span>
                                        </div>
                                 </div>
                            </div>
        ...
        <ais-pagination class="pagination" :classNames="{ 'ais-pagination': 'pagination ', 'ais-pagination__item--active': 'active','ais-pagination__item--disabled': 'disabled' }">
        </ais-pagination>
        </div>
