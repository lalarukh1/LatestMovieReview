<template>
    <div id="app">
        ...
        <div class="bg-purple-darker text-center py-4 mt-8 shadow-md">
            <div class="p-3 bg-purple-darkest items-center text-indigo-lightest leading-normal lg:rounded=lg md:rounded-lg flex px-4 lg:inline-flex md:inline-flex lg:py-3 md:py-3 sm:py-8 py-8">
